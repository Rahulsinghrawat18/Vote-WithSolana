  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col justify-center items-center space-y-6 w-full">
        ...
        <form
          className="bg-rose-100 border border-gray-300 rounded-2xl
        ...
        >
          <div>
            ...
            <input
              ...
              focus:outline-none bg-gray-400 text-gray-800 placeholder-gray-800"
          ...
          <div>
            ...
            <input
              ...
              className="mt-2 block w-full py-3 px-4 border border-gray-300
              rounded-lg shadow-sm focus:ring-2 focus:ring-black
              focus:outline-none bg-gray-400 text-gray-800"
              style={{ zIndex:10 }}
